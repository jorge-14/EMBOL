 ...
 *   Código de Objeto: TblRegionalUpdateRequestDto
 *   Descripción: DTO de solicitud para actualización de TblRegional (TBL_REGIONAL)
...
@NoArgsConstructor
@AllArgsConstructor
public class TblRegionalUpdateRequestDto {
